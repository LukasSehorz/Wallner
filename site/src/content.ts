...
export const leistungen: Leistung[] = [
  {
    ...
    galerie: [
      ...
      { bild: '/bilder/innenausbau-flur-rohbau.jpg', alt: 'Badezimmer im Ausbau mit großformatigen Fliesen in dunkler Marmoroptik' },
    ],
  ...
  },
  {
    ...
    galerie: [
      ...
      { bild: '/bilder/terrasse-holzdeck.jpg', alt: 'Terrasse mit Feinsteinzeug-Platten 90x60 in Natursteinoptik und Holzgeländer' },
